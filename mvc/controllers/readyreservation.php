...
class Readyreservation extends Controller {
	...
	function index() 
	{	
		$this->view->readyReservationList = $this->model->readyReservationList(Session::get('IDuser'));
		$this->view->render('readyreservation/index');
	}
